(() => {
    ...
    $(".video-block-play").click((function(e) {
        e.preventDefault();
        $(this).parent().parent().addClass("active");
        $(".video-block-iframe").html('<iframe width="956" height="538" src="https://www.youtube.com/embed/' + $(this).attr("data-video") + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
    }));
    window["FLS"] = false;
    isWebp();
    menuInit();
